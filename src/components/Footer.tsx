        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="md:col-span-6 space-y-2 md:space-y-4">
            ...
            <p className="text-xs md:text-sm text-muted-foreground leading-relaxed max-w-xl">
              PP Collections is Kerala's finest curated fashion destination, built
              to deliver simplicity, elegance, and a premium shopping experience.
              With a thoughtfully designed collection, it transforms the way you
              discover and shop for fashion.
            </p>
          </div>

          {/* Mobile wrapper for Legal + Contact */}
          <div className="grid grid-cols-2 gap-6 md:contents">
            ...
            <div className="md:col-span-3 space-y-2 md:space-y-4">
              ...
              <div className="space-y-1.5 md:space-y-3">
                <Link
                  to="/privacy"
                  className="block text-xs md:text-sm text-foreground hover:text-primary transition-colors"
                >
                  Privacy Policy
                </Link>
